prof_mat <- function(unit = c("coding", "file"), case_ids = NULL, case_names = NULL){
    ...
    w <- gwindow(title=sprintf(gettext("Profile Matrix - %s", domain = "R-RQDA"), unit),
    width = getOption("widgetSize")[1], height = getOption("widgetSize")[2],visible=FALSE, parent = c(wnh[1]+10, 2))
