...
\details{
  It is a wrapped version of \code{\link[DBI]{dbSendStatement}}, to make it more
  convenient to submit and execute a SQL statement.
}
\value{
  The same of \code{\link[DBI]{dbSendStatement}}, possible NULL (for the side effects of
...
\seealso{
   See Also as \code{\link[DBI]{dbSendStatement}}
}
\examples{
\dontrun{
