...
<title>Binary operations of some types of RQDA objects — Ops.RQDA • RQDA</title>
...
<meta property="og:title" content="Binary operations of some types of RQDA objects — Ops.RQDA" />
<meta property="og:description" content="Binary operations of RQDA.vector or codingsByOne." />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Binary operations of some types of RQDA objects</h1>
    
    <div class="hidden name"><code>Ops.RQDA.rd</code></div>
    </div>
...
<span class='va'>e1</span> <span class='op'>%not%</span> <span class='va'>e2</span></pre>
    ...
    <p>e1 and e2 can be objects of class "RQDA.vector" includes classes of "fileId", "fileName", "caseId", "caseName". They can be objects of class "codingsByOne", see <code><a href='getCodingsByOne.html'>getCodingsByOne</a></code>. e1 and e2 must be the same class.</p>
<p>For class of "RQDA.vector", <code>%and%</code> is the <code><a href='https://rdrr.io/r/base/sets.html'>intersect</a></code> of e1 and e2. <code>%or%</code> is the <code><a href='https://rdrr.io/r/base/sets.html'>union</a></code> of e1 and e2. <code>%not%</code> is the defined as <code><a href='https://rdrr.io/r/base/sets.html'>setdiff(e1, e2)</a></code>.</p>
