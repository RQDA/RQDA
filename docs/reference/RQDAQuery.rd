...
<title>Execute a SQL statement on the open *.rqda file. — RQDAQuery • RQDA</title>
...
<meta property="og:title" content="Execute a SQL statement on the open *.rqda file. — RQDAQuery" />
<meta property="og:description" content="Submits and executes an arbitrary SQL statement on the open *.rqda file." />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Execute a SQL statement on the open *.rqda file.</h1>
    
    <div class="hidden name"><code>RQDAQuery.rd</code></div>
    </div>
    ...
    <tr>
      <th>sql</th>
      <td><p>a character vector of length 1 with the SQL statement.</p></td>
    </tr>
    </table>

    <h2 class="hasAnchor" id="details"><a class="anchor" href="#details"></a>Details</h2>

    <p>It is a wrapped version of <code><a href='https://dbi.r-dbi.org/reference/dbSendStatement.html'>dbSendStatement</a></code>, to make it more
  convenient to submit and execute a SQL statement.</p>
