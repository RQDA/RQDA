...
<title>Summary of codings — summaryCodings • RQDA</title>
...
<meta property="og:title" content="Summary of codings — summaryCodings" />
<meta property="og:description" content="Give a summary of codings of current project." />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Summary of codings</h1>
    
    <div class="hidden name"><code>summaryCodings.rd</code></div>
    </div>
...
<span class='fu'><a href='https://rdrr.io/r/base/print.html'>print</a></span>(<span class='no'>x</span>, <span class='no'>...</span>)</pre>
    ...
    <tr>
      <th>byFile</th>
      <td><p>When it is FALSE, return the summary of current project. 
When it is TRUE, return the summary of coding for each coded file.</p></td>
    </tr>
    <tr>
      <th>x</th>
      <td><p>An object returned by <code>summaryCoding</code>.</p></td>
    </tr>
    <tr>
      <th>...</th>
      <td><p>Other possible arguments.</p></td>
    </tr>
    </table>
    ...
    <p>A list:</p>
<dt>NumOfCoding</dt><dd><p>Number of coding for each code.</p></dd>
	<dt>AvgLength</dt><dd><p>Average number of characters in codings for 
each code.</p></dd>
	<dt>NumOfFile</dt><dd><p>Number of files coded for each code.</p></dd>
